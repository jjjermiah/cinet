...
write.csv(dat_acc, "C:/Users/marcd/OneDrive/Escritorio/UHN/DeepCINET/PSets/csv/CCLE-aac.csv", row.names=TRUE)
write.csv(dat_expr, "C:/Users/marcd/OneDrive/Escritorio/UHN/DeepCINET/PSets/csv/CCLE-v2-expr.csv", row.names=TRUE)
